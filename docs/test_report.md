...
5. **关联 `C++_learning` 书目与 Readest 阅读链接**，支持物理印刷页码定位与浏览器 / 桌面应用跳转；
...
| **07** | **语法 ➔ muduo 映射** | 15 项核心机制映射表格渲染 | **15 行完整呈现** | **15 行完整呈现** | **PASS** |
...
4. **支持书目阅读定位**：无论是直接浏览器阅读还是配合 Readest 桌面端阅读，均可定位到具体页码；
